...
public interface IDOTVisitor<Result> : IParseTreeVisitor<Result> {
	...
	Result VisitGlobalAttrStmt([NotNull] DOTParser.GlobalAttrStmtContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitNodeStmt([NotNull] DOTParser.NodeStmtContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitEdgeStmt([NotNull] DOTParser.EdgeStmtContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitAttrStmt([NotNull] DOTParser.AttrStmtContext context);
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitSubgraphStmt([NotNull] DOTParser.SubgraphStmtContext context);
